...
function About() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>About TimeCounterPro - Free Online Timer Tools</title>
        <meta name="description" content="Learn about TimeCounterPro — free online countdown timer, stopwatch and Pomodoro timer for study, workouts and productivity." />
